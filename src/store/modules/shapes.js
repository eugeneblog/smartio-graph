...
class AppShapes {
    @observable shapesList = [{
        ...
        svgGroup: [
            ...
            `<g><path d="M 7 10 C 7 0 35 0 35 10 L 35 32 C 35 42 7 42 7 32 Z" fill="#ffffff" stroke="#000000"></path><path d="M 7 10 C 7 17 35 17 35 10" fill="none" stroke="#000000" stroke-miterlimit="10" pointer-events="all"></path></g>`
        ]
    }, {
        id: '2',
        header: 'General',
